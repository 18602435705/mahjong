    ...
    <section className={styles.hero}>
      <div className={styles.heroContent}>
        ...
        <div className={styles.heroCtaGroup}>
          ...
          <a href="#solutions" className={`${styles.btn} ${styles.btnSecondary}`}>
  ...
  return (
    <section id="trust" className={styles.trust}>
      <div className={styles.sectionHeader}>
        ...
        <h2 className={styles.sectionTitle}>Industry Leaders Choose Sentinel</h2>
      </div>
      <div className={styles.trustLogos}>
        {trustLogos.map((logo, index) => (
          <div key={index} className={styles.trustLogo}>{logo}</div>
        ))}
      </div>
        ...
        {testimonials.map((testimonial, index) => (
          <div key={index} className={styles.testimonialCard}>
            ...
            <div className={styles.testimonialAuthor}>
              <div className={styles.testimonialAvatar}>{testimonial.initial}</div>
